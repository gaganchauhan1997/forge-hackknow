...
export default function AppDashboard() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 pb-24 md:pb-8">
      {/* Greeting */}
      <div className="mb-6">
        <h1 className="font-oswald text-2xl md:text-3xl font-bold">
          Hi, {user.name || "User"} 👋
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {/* Resume Score */}
        <div className="bg-white border-2 border-[#1a1a1a]/10 p-5 flex items-center gap-4">
          <div className="relative w-20 h-20 shrink-0">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="font-oswald text-2xl font-bold">{resumeScore}</span>
              <span className="text-[9px] text-[#1a1a1a]/50">/100</span>
            </div>
          </div>
          <div>
            <h3 className="font-oswald text-sm font-bold uppercase">Your Resume Score</h3>
        ...
        <div className="bg-white border-2 border-[#1a1a1a]/10 p-5 flex items-center gap-4">
          <div className="w-16 h-16 bg-[#F9FF00]/20 flex items-center justify-center text-3xl shrink-0">
            📊
          </div>
          <div>
            <p className="text-[10px] text-[#1a1a1a]/40 font-inter uppercase tracking-wider">Next Recommended Step</p>
            <h3 className="font-oswald text-sm font-bold mt-1">ATS Career Intelligence</h3>
            ...
            <Link to="/app/tool/ats" className="inline-flex items-center gap-1 mt-2 font-oswald text-xs font-bold hover:text-[#FF0004] transition-colors">
        ...
        {/* Your Progress */}
        <div className="bg-white border-2 border-[#1a1a1a]/10 p-5">
          <h3 className="font-oswald text-sm font-bold uppercase">Your Progress</h3>
          <p className="font-inter text-xs text-[#1a1a1a]/60 mt-1">
            {completedModules}/{totalModules} Modules Completed
          </p>
          <div className="mt-3 w-full h-3 bg-[#f0f0f0]">
            <div
          ...
          {progressPercent === 100 && (
            <p className="font-inter text-xs text-green-600 mt-1">Great job! Keep it up 🚀</p>
          )}
        </div>
      </div>
      ...
      {/* All Tools Grid */}
      <div className="mb-8">
        <h2 className="font-oswald text-xl font-bold mb-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
          {CATEGORIES.map((cat) => {
            ...
            return (
              <div key={cat.id} className="bg-white border-2 border-[#1a1a1a]/10 p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <div>
                    <h3 className="font-oswald text-xs font-bold uppercase">{cat.label}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="lg:col-span-3">
          <div className="flex items-center justify-between mb-3">
            <h2 className="font-oswald text-lg font-bold">Recent Resumes</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {resumes.slice(0, 4).map((resume) => (
              <div key={resume.id} className="bg-white border-2 border-[#1a1a1a]/10 p-4">
                ...
                <h3 className="font-oswald text-xs font-bold">{resume.title}</h3>
                ...
                <div className="flex items-center gap-2 mt-3">
                  <div className="w-7 h-7 flex items-center justify-center bg-[#F9FF00]/20 text-[10px] font-bold" style={{ borderRadius: "50%" }}>
                    {resume.atsScore}
                  </div>
                  <div>
        ...
        <div className="bg-white border-2 border-[#1a1a1a]/10 p-4">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-8 h-8 bg-[#F9FF00] flex items-center justify-center text-lg" style={{ borderRadius: "50%" }}>
              🤖
            </div>
            <div>
              <h3 className="font-oswald text-sm font-bold">AI Yahavi</h3>
              <p className="text-[9px] text-green-500 font-inter">● Always here to help</p>
            </div>
          </div>

          {!user.loggedIn && (
            <p className="font-inter text-xs text-[#1a1a1a]/60 mb-3">
          ...
          <div className="space-y-2">
            {[
              ...
              <Link
                key={item.label}
                to={item.to}
                className="flex items-center gap-2 text-xs font-inter py-1.5 hover:text-[#FF0004] transition-colors"
              >
                <span>{item.icon}</span>
                {item.label}
              </Link>
          ...
          <Link
            to="/app/yahavi"
            className="flex items-center justify-between mt-4 pt-3 border-t border-[#1a1a1a]/10 text-xs font-oswald font-bold hover:text-[#FF0004] transition-colors"
          >
