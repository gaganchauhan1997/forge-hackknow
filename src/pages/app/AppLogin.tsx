      ...
      <div className="w-full max-w-md">
        <div className="bg-white border-2 border-[#1a1a1a]">
          ...
          <div className="px-6 py-6 space-y-4">
            ...
            <div>
              <label className="block font-oswald text-xs font-bold uppercase tracking-wider mb-1 text-[#1a1a1a]">
                Your Name *
              </label>
              <input
                type="text"
            ...
            <button
              onClick={handleLogin}
              disabled={!name.trim()}
              className="w-full flex items-center justify-center gap-2 bg-[#F9FF00] text-[#1a1a1a] py-3 font-oswald font-bold uppercase text-sm border-2 border-[#1a1a1a] hover:bg-[#e6e600] transition-colors disabled:opacity-50"
            >
              <LogIn size={18} />
              SIGN IN
            </button>
