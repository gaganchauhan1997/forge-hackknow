  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 pb-24 md:pb-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="font-oswald text-2xl font-bold text-[#1a1a1a] uppercase">My Resumes</h1>
        ...
        <Link
          to="/app/tool/builder"
          className="flex items-center gap-2 bg-[#F9FF00] text-[#1a1a1a] px-4 py-2 font-oswald text-xs font-bold uppercase border-2 border-[#1a1a1a] hover:bg-[#e6e600] transition-colors"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {resumes.map((resume) => (
          <div key={resume.id} className="bg-white border-2 border-[#1a1a1a] p-4 hover:border-[#F9FF00] transition-colors">
            <div className="flex items-start justify-between mb-4">
              <div
                className="w-12 h-12 flex items-center justify-center text-white font-oswald font-bold border-2 border-[#1a1a1a]"
            ...
            <h3 className="font-oswald text-sm font-bold text-[#1a1a1a]">{resume.title}</h3>
            ...
            <div className="flex items-center gap-2 mt-3 pt-3 border-t-2 border-[#1a1a1a]/10">
              <div
                className="w-8 h-8 flex items-center justify-center text-[10px] font-bold text-[#1a1a1a] bg-[#F9FF00] border border-[#1a1a1a]"
        ...
        <Link
          to="/app/tool/builder"
          className="border-2 border-dashed border-[#1a1a1a]/30 p-8 flex flex-col items-center justify-center text-center hover:border-[#F9FF00] transition-colors min-h-[180px]"
        >
